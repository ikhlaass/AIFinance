...
const TransactionItem = ({ type, description, date, amount }) => {
  ...
  return (
    <div className="flex items-center gap-4 py-4 px-6 rounded-2xl bg-card border border-card-border hover:border-primary/30 transition-colors shadow-sm">
      ...
      <div className="flex-1">
        ...
        <span className="text-[10px] text-text-muted uppercase tracking-widest">{date}</span>
      </div>
